...
# 잔차 계산 (예시로 y_pred와 a*sin(b*pi*t)의 차이를 사용)
...
def total_loss_function(y_pred, y_true, t, lambda_data=1.0, lambda_physics=1.0):
    # 데이터 손실 (DNN 손실)
...
optimizer = optim.Adam([{'params': model.parameters()}, {'params': [a, b]}], lr=0.001)
